...
export default function NotificationPanel() {
  ...
  return (
    <div className="flex gap-6 h-[500px] bg-gray-900 rounded-lg p-4">
        ...
        {notifications.map((note) => (
          ...
          >
            <div className="flex justify-between items-center">
              ...
              {!note.read && (
                <span className="text-xs bg-red-600 px-2 rounded text-white">
                  ●
                </span>
              )}
            </div>
      ...
      <div className="w-2/3 p-4 bg-gray-800 rounded-md h-full">
        {selected ? (
          <>
